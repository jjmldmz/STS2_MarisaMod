...
public class BoundOfProtagonists : AbstractAmplifiedCard //AbstractMarisaCard
{
    public BoundOfProtagonists() : base(2, 1, CardType.Power, CardRarity.Rare, TargetType.Self)
    {
    }
